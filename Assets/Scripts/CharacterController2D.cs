...
public class CharacterController2D : MonoBehaviour
{
	...
	private CapsuleCollider2D cc; //capsule and slope check variables
	...
	public void SlopeCheck(float move)
	{
	...
	public void Move(float move, bool crouch, bool jump)
	{
		...
		if (m_Grounded || m_AirControl)
		{
			...
			{
				newVelocity.Set(move*10f,0.0f);
				m_Rigidbody2D.velocity = Vector3.SmoothDamp(m_Rigidbody2D.velocity, newVelocity, ref m_Velocity, m_MovementSmoothing);
			}
			else if(m_Grounded && isOnSlope)
			{
				newVelocity.Set(-move*10f * slopeNormalPerp.x, -move*slopeNormalPerp.y*10f);
				m_Rigidbody2D.velocity = Vector3.SmoothDamp(m_Rigidbody2D.velocity, newVelocity, ref m_Velocity, m_MovementSmoothing);
			}
			else if(!m_Grounded)
			{
				newVelocity.Set(move*10f, m_Rigidbody2D.velocity.y);
				m_Rigidbody2D.velocity = Vector3.SmoothDamp(m_Rigidbody2D.velocity, newVelocity, ref m_Velocity, m_MovementSmoothing);
			}
